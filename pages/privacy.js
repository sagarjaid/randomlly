...
const Privacy = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy — Randomlly</title>
        <meta name="title" content="Privacy Policy — Randomlly" />
        <meta
          name="description"
        ...
        <meta property="og:url" content="https://randomlly.com/privacy" />
        <meta property="og:title" content="Privacy Policy — Randomlly" />
        <meta
        ...
        <meta property="twitter:url" content="https://randomlly.com/privacy" />
        <meta property="twitter:title" content="Privacy Policy — Randomlly" />
        <meta
      ...
      <main className="m-auto flex max-w-5xl flex-col px-4">
        ...
        <div className="flex flex-col items-start justify-center gap-6 p-2 py-10 ">
          ...
          <p>
            Randomlly.com follows a standard procedure of using log files. These
