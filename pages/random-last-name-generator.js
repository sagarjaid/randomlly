...
const Home = () => {
  ...
  useEffect(() => {
    handleGenerateRandomFName()
  }, [])


  const handleGenerateRandomFName = () => {
        ...
        <div className="flex flex-col gap-8 pt-2">
          ...
          <div className="flex flex-col gap-4 items-center border h-80 sm:h-none justify-center sm:w-1/2">
            <span onClick={handleCopyToClipboard} className="flex gap-2 justify-center items-center cursor-pointer">
              <span className="text-3xl font-extrabold">{fname}</span>
            ...
            <button onClick={handleGenerateRandomFName} className="p-2 flex gap-3 px-3 mt-3 items-center bg-blue-500 text-white rounded-md w-fit ">
